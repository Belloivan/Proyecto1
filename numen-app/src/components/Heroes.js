...
const Heroes = () => {
  return (
    ...
    < div className = "flex flex-col items-stretch px-6 py-8 lg:flex-row justifica-entre lg:px-0 lg:py-20 2xl:mx-auto 2xl:container" > 
        < div className = "z-30 relativo lg:w-1/2" > 
            < div className = "items-center hidden w-full bg-gray-100 dark:bg-gray-800 lg:w-10/12 lg:h-full lg:flex allow-end" > 
                < div className = "w-full lg:w-auto lg:-mr-32" > 
                    < img src = " https://www.ubuy.com.ar/productimg/?image=aHR0cHM6Ly9tLm1lZGlhLWFtYXpvbi5jb20vaW1hZ2VzL0kvNzFKaEF5NFU0Q1MuX0FDX1NMMTUwMF8uanBn.jpg " alt = " imagen con sillas decentes " className = "z-30 w-full px-6 pariente lg :pl-20 py-14" />    
                </ div >
            </ div >
        ...
        < div className = "flex items-center p-8 bg-gray-100 dark:bg-gray-800 lg:w-1/2 lg:ml-12 lg:p-14" > 
            < div >
                < h1 className = " dark:text-white md:w-8/12 lg:w-10/12 xl:8/12 2xl:w-8/12 w-full xl:text-6xl sm:text-5xl text -4xl font-semibold text-gray-800 mayúsculas " > AirTag </ h1 > 
